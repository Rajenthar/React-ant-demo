...
class Sign extends Component {
  ...
  signin = () => {    
    ...
    console.log("NOW INSIDE SIGNIN METHOD");
    console.log(this.state.username);
        console.log(this.state.password);
...
.then((findresponse)=>{
  ...
  this.setState({
    ...
    render() {   
          return (    
              <div id="sign">    
                  <h3 className="text-center text-white pt-5">Creating new user</h3>    
                  <div className="container">    
                      ...
                      <div className="form-group">    
                          <input type="password" name="password" onChange={this.handleChange}  className="form-control" placeholder="password" />    
                           ...
                           <input type="submit" name="submit" onClick={this.signin}  className="btn btn-info btn-md" value="Register"/>    
                       </div>    
                      </div>    
                      </div>    
              </div>    
